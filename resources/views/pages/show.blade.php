            ...
            <div class="col-md-8">
                <article class="post">
                    ...
                    <div class="post-content">
                        ...
                        @if($post->hasCategory())
                            <h6><a href="{{route('category.show', $post->categories->slug)}}"> {{$post->getCategoryTitle()}}</a></h6>
                            @else
                            <h6><a> Категории нет</a></h6>
                        @endif
                        ...
                        <div class="social-share">
                            <span
                        class="social-share-title pull-left text-capitalize">By {{$post->author->name}} On {{$post->getDate()}}, просмотров: {{$post->views}}</span>
                    ...
                    @foreach($post->getComments() as $comment)
                        <div class="bottom-comment"><!--bottom comment-->
                            <div class="comment-img">
                                <img class="img-circle" src="{{$comment->author->getImage()}}" alt="" height="75" width="75">
                            </div>
